<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(detailArray,index) in detailArrayList" :key="index">
          <li>
            <img :src="detailArray.imgUrl" alt />
          </li>
          <li>
    ...
    <div class="sub clearFix">
      <a href="javascript:" class="subBtn" @click="toSubOrder">提交订单</a>
    </div>
  </div>
</template>
